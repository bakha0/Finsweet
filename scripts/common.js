...
$(function () {
  $('.header__nav-button').on('click', function () {
    ...
    $('.header__nav-cancel').addClass('header__nav-cancel-active');
  });
  $('.header__nav-cancel').on('click', function () {
    $('.header__nav-list').removeClass('header__nav-list-active');
    $('.header__nav-cancel').removeClass('header__nav-cancel-active');
  });
});
...
const canButton = document.querySelector('.can__box-text-button-1');
const canDonate = document.querySelector('.know__box-link');
const canModal = document.querySelector('.can__modal');
const canCancel = document.querySelector('.can__cancel');
const canCancelIcon = document.querySelector('.can__modal-box-cancel');
canButton.addEventListener('click', function () {
  canModal.classList.add('can__modal-active');
  canCancel.classList.add('can__cancel-active');
});
canDonate.addEventListener('click', function () {
  canModal.classList.add('can__modal-active');
  canCancel.classList.add('can__cancel-active');
});
canCancelIcon.addEventListener('click', function () {
  canModal.classList.remove('can__modal-active');
  canCancel.classList.remove('can__cancel-active');
});
const protect_Button_1 = document.querySelector('.protect__right-buttons-1');
const protect_Button_2 = document.querySelector('.protect__right-buttons-2');
const protect_Button_3 = document.querySelector('.protect__right-buttons-3');
const protect_content_1 = document.querySelector('.protect__right-content-box1');
const protect_content_2 = document.querySelector('.protect__right-content-box2');
const protect_content_3 = document.querySelector('.protect__right-content-box3');
protect_Button_1.addEventListener('click', function () {
  protect_content_2.classList.remove('protect__right-content-active');
  protect_content_3.classList.remove('protect__right-content-active');
  protect_content_1.classList.add('protect__right-content-active');
  protect_Button_2.classList.remove('protect__right-buttons-active');
  protect_Button_3.classList.remove('protect__right-buttons-active');
  protect_Button_1.classList.add('protect__right-buttons-active');
});
protect_Button_2.addEventListener('click', function () {
  protect_content_1.classList.remove('protect__right-content-active');
  protect_content_3.classList.remove('protect__right-content-active');
  protect_content_2.classList.add('protect__right-content-active');
  protect_Button_1.classList.remove('protect__right-buttons-active');
  protect_Button_3.classList.remove('protect__right-buttons-active');
  protect_Button_2.classList.add('protect__right-buttons-active');
});
protect_Button_3.addEventListener('click', function () {
  protect_content_1.classList.remove('protect__right-content-active');
  protect_content_2.classList.remove('protect__right-content-active');
  protect_content_3.classList.add('protect__right-content-active');
  protect_Button_1.classList.remove('protect__right-buttons-active');
  protect_Button_2.classList.remove('protect__right-buttons-active');
  protect_Button_3.classList.add('protect__right-buttons-active');
});